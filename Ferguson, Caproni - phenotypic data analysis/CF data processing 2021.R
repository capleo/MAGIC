...
setwd("~/My Drive/Maize 2021 analyses/Fluorescence/Raw data/")
...
ggplot(data=filtered_output, aes(x=cumulative_time, y=NPQ_values, colour=Repeat)) +
  geom_point()+
  theme_classic()+
  facet_wrap_paginate( ~ Plot, ncol= 5, nrow = 5, page = 10)
...
write_xlsx(filtered_output, path = "~/My Drive/Maize 2021 analyses/Fluorescence/NPQdata.xlsx")
